(function (name, definition) {
    ...
    var context = this,
        ...
        transform = function () {
            var styles = doc.createElement('a').style, props = ['webkitTransform', 'MozTransform', 'OTransform', 'msTransform', 'Transform'], i
    ...
    function tween(duration, fn, done, ease, from, to) {
        ...
        var time = duration || 1000, self = this, diff = to - from, start = +new Date(), stop = 0, end = 0
        frame(run)
